...
const CartTotals = (props) => {
    ...
    return (
        <div className="totals flex flex-col gap-y-2 w-5/6 pt-5 border-t-2 border-gray-300 border-solid">
            ...
            <div className="w-3/4 self-end flex items-baseline justify-end">
                ...
                <div className="w-3/5 font-bold text-4xl text-right text-purple-600"> ${total.toFixed(2)} </div>
            </div>
        </div>
    )
}
